...
public interface HplsqlVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link HplsqlParser#typeof}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitTypeof(HplsqlParser.TypeofContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link HplsqlParser#assignment_query_stmt}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitAssignment_query_stmt(HplsqlParser.Assignment_query_stmtContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link HplsqlParser#execute_query_stmt}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitExecute_query_stmt(HplsqlParser.Execute_query_stmtContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link HplsqlParser#bool_expr_is_not_null}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitBool_expr_is_not_null(HplsqlParser.Bool_expr_is_not_nullContext ctx);

    /**
     * Visit a parse tree produced by {@link HplsqlParser#bool_expr_between}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitBool_expr_between(HplsqlParser.Bool_expr_betweenContext ctx);

    /**
     * Visit a parse tree produced by {@link HplsqlParser#bool_expr_exists}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitBool_expr_exists(HplsqlParser.Bool_expr_existsContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link HplsqlParser#parenthesis_open}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitParenthesis_open(HplsqlParser.Parenthesis_openContext ctx);

    /**
     * Visit a parse tree produced by {@link HplsqlParser#parenthesis_close}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitParenthesis_close(HplsqlParser.Parenthesis_closeContext ctx);
